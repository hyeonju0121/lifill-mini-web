...
public class AdminItemController {
	...
	public String itemLis(String pageNo, Model model, HttpSession session) {
		...
		/*
		 * 상품 수정하기에서 목록을 누르면 첫번째 페이지로 이동 -> session에서 페이지 넘버 가져오기 pageNo를 받지 못했을 경우,
		 * 저장되어있는지 확인
		 */
		if (pageNo == null) {
	...
	public String updateItemForm(String prdcode, Model model) {
		log.info("실행");
	...
	public String updateItem(CreateProductRequest request) {
		log.info("실행");
