					...
					<div class="wrapper" style="width:1150px; margin-bottom:15px;">
						...
						<div class="category3" id="goCategory3">
							<ul class="goCategory3" data-code="ingredient" >
								...
								<li class=""><a href="#" data-code="nutrient">간 건강</a></li>
								<li class=""><a href="#" data-code="lactobacillus">눈 건강</a></li>
								<li class=""><a href="#" data-code="omega3">장 건강</a></li>
								<li class=""><a href="#" data-code="supplements">만성 피로</a></li>
								<li class=""><a href="#" data-code="supplements">수면, 스트레스</a></li>
							</ul>
									...
									<li class="store-product-wrapper"><a href="${pageContext.request.contextPath}/item/item_view"
										onclick="selectStoreProduct(this, '');">
											...
											<div class="store-product-content">
												...
												<h4>
													<em>${productResponse.prdbrand}</em> ${productResponse.prdname}
												</h4>
												<p>
												...
												<div>
													<div>
														<span class="icon-rating"><img
													src="${pageContext.request.contextPath}/resources/image/icon/star.png"/></span> 4.9
													</div>
													<div>(후기 626)</div>
												</div>
												<div class="hashtag">
													<div># ${productResponse.tagval}</div>
												</div>
											</div>
									</a></li>
								</c:forEach>
