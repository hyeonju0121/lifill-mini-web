							...
							$('#prdsubscribable')
									.change(
											function() {
												...
												if (isChecked) {
													location.href = "${pageContext.request.contextPath}/item/categories/function?subCategory=${param.subCategory}&sort=0&filter=1&pageNo=1";
												} else {
													location.href = "${pageContext.request.contextPath}/item/categories/function?subCategory=${param.subCategory}&sort=0&filter=0&pageNo=1";
												}
											});
						});
	</script>
...
<body>
			...
			<div class="wrapper" style="width: 1150px; margin-bottom: 15px;">
				...
				<div class="category3" id="goCategory3">
					<ul class="goCategory3" data-code="ingredient">
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=all&filter=0&sort=0&pageNo=1"
							data-code="all">전체</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=001&filter=0&sort=0&pageNo=1"
							data-code="001">눈건강</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=002&filter=0&sort=0&pageNo=1"
							data-code="002">장건강</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=003&filter=0&sort=0&pageNo=1"
							data-code="003">간건강</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=004&filter=0&sort=0&pageNo=1"
							data-code="004">뼈/관절건강</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=005&filter=0&sort=0&pageNo=1"
							data-code="005">면역력</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=006&filter=0&sort=0&pageNo=1"
							data-code="006">만성피로</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=007&filter=0&sort=0&pageNo=1"
							data-code="007">혈액순환</a></li>
					</ul>
				</div>
			</div>
		</section>
		...
		<section class="list">
			<div class="wrapper" style="width: 1150px; margin-bottom: 15px;">
				...
				<br> <input type='checkbox' id='prdsubscribable' style="" />구독
				가능 상품
	
				<div class="sort-nav">
					<ul class="product-sort">
						<li class="on" data-sort="0"><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=${param.subCategory}&sort=0&filter=${param.filter}&pageNo=1">최신순</a></li>
						<li class="on" data-sort="0"><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=${param.subCategory}&sort=1&filter=${param.filter}&pageNo=1">높은가격순</a></li>
						<li class="on" data-sort="0"><a
							href="${pageContext.request.contextPath}/item/categories/function?subCategory=${param.subCategory}&sort=2&filter=${param.filter}&pageNo=1">낮은가격순</a></li>
					</ul>
				</div>
	
				<ul id="items">
					<c:forEach var="productResponse" items="${productResponseList}">
						<li class="store-product-wrapper"><a
							href="${pageContext.request.contextPath}/item/item_view?prdcode=${productResponse.prdcode}"
							onclick="selectStoreProduct(this, '');">
								...
								<div class="store-product-content">
									...
									<p style="font-weight: 500;">${productResponse.prdprice} 원</p>
									<div>
										<div>
											<span><img class="icon-rating"
												src="${pageContext.request.contextPath}/resources/image/icon/star1.png" /></span>
											4.9
											<div
												style="margin-bottom: 7px; margin-top: 7px; font-size: 14px;">(후기626)</div>
										</div>
									</div>
									<div>
			...
			<div class="pager">
				<a class="btn btn-sm first-page" href="function?subCategory=${param.subCategory}&sort=${param.sort}&filter=${param.filter}&pageNo=1">처음</a>
				<c:if test="${pager.groupNo>1}">
					<a class="btn btn-sm prev-group"
						href="function?subCategory=${param.subCategory}&sort=${param.sort}&filter=${param.filter}&pageNo=${pager.startPageNo-1}">이전</a>
				</c:if>
