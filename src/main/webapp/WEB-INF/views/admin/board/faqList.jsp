		...
		<div class="wrapper">
			...
			<div class="main p-3">
				...
				<div class="headingArea">
					<div class="title">
						<h1 id="itemTitle">자주묻는질문 목록</h1>
					</div>
				</div>
				
				<div class="section_block">
					<div class="sub bg-light">
						<button type="button" class="btn btn-outline-dark createNotice-btn mt-3 me-2" onclick="location.href='${pageContext.request.contextPath}/admin/board/writeNotice'">자주묻는질문 등록</button>
					</div>
