									...
									<div class="section_block1">
										<div class="form_table">
													...
													<div class="item_wrap">
														...
														<div class="itemDetail itemDetail_attach">
															...
															<div class="img_box d-flex">
																...
																<img src="${pageContext.request.contextPath}/resources/image/item_detail/eye/eye3_detail.png" 
																	class="rounded-3" style="width:90px;height:90px;"/>
															</div>
												...
												<div class="td">
													<div class="form_set">
														<div class="input_clear sm">
															<input type="text" id="masItemName" value="락토핏 골드 2g">
														</div>
											...
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masBrand" value="종근당">
													</div>
												</div>
											</div>
											<div class="tr">
												...
												<div class="td">
													<div class="form_set">
														<div class="input_clear sm">
															<input type="text" id="masItemPrice" value="28,900">
														</div>
									...
									<div class="section_block1">
										<div class="form_table">
											...
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masPerson" value="성인용">
													</div>
												</div>
											</div>
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masBrand" value="눈 건강 개선">
													</div>
												</div>
											</div>
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masBrand" value="알약, 캡슐">
													</div>
												</div>
											</div>
											<div class="tr">
											...
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masBrand" value="물과 함께 섭취">
													</div>
												</div>
											</div>
											<div class="tr">
												...
												<div class="td">
													<div class="input_clear sm">
														<input type="text" id="masBrand" value="루테인 20mg, 아스타잔틴 12mg">
													</div>
												</div>
											</div>
										</div>
